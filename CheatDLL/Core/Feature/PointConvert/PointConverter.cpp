...
Point CPointConverter::ConvertClientPosToGamePos(_In_ CONST Point& ClientPos)
{
	...
	*/
	...
	float fxmm0 = fabs(P[14]) - fabs(ReadFloat(dwInGameState + 游戏坐标转换偏移2));
...
/*
	...
	P[0] = ReadFloat(dwInGameState + 游戏坐标转换偏移1 + 0x10 + 0x0);
	P[1] = ReadFloat(dwInGameState + 游戏坐标转换偏移1 + 0x10 + 0x10);
	P[2] = 0.0f;
	P[3] = 0.0f;
	P[4] = ReadFloat(dwInGameState + 游戏坐标转换偏移1 + 0x10 + 0x4);
	P[5] = ReadFloat(dwInGameState + 游戏坐标转换偏移1 + 0x10 + 0x14);
	P[6] = ReadFloat(dwInGameState + 游戏坐标转换偏移1 + 0x10 + 0x24);
	P[7] = 0.0f;
	P[8] = ReadFloat(dwInGameState + 游戏坐标转换偏移1 + 0x10 + 0x8);
	P[9] = ReadFloat(dwInGameState + 游戏坐标转换偏移1 + 0x10 + 0x18);
	P[10] = ReadFloat(dwInGameState + 游戏坐标转换偏移1 + 0x10 + 0x28);
	P[11] = -0.0f; // => 0x80000000
	P[12] = ReadFloat(dwInGameState + 游戏坐标转换偏移1 + 游戏坐标转换偏移3 + 0x0);
	P[13] = ReadFloat(dwInGameState + 游戏坐标转换偏移1 + 游戏坐标转换偏移3 + 0x4);
	P[14] = ReadFloat(dwInGameState + 游戏坐标转换偏移1 + 游戏坐标转换偏移3 + 0x8);
	P[15] = 1.0f;
