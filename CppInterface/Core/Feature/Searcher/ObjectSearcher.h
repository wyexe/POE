#ifndef __LFZL_CPPINTERFACE_CORE_FEATURE_SEARCHER_OBJECTSEARCHER_H__
#define __LFZL_CPPINTERFACE_CORE_FEATURE_SEARCHER_OBJECTSEARCHER_H__
...
#endif // !__LFZL_CPPINTERFACE_CORE_FEATURE_SEARCHER_OBJECTSEARCHER_H__
